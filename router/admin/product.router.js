...
router.post("/create",upload.single('thumbnail'),mulerCloud.mulerCloud,productValidate.createPost,productController.createPost)
router.get("/edit/:id",productController.edit)
router.patch("/edit/:id",upload.single('thumbnail'),mulerCloud.mulerCloud,productValidate.createPost,productController.editPost)
